...
Phase 1 browser client for the [Axona](https://github.com/axona-net) protocol. Connects to an [`axona-bridge`](https://github.com/axona-net/axona-bridge) over WebSocket, sends a ping every second, and renders the connection state as a colored indicator.
